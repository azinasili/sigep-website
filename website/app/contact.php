...
<html class="no-js">
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    ...
    <!-- Document meta data -->
    <title>SigEp PABB Drexel University | Contact SigEp</title>
    <meta name="description" content="Reach out to the brothers of Sigma Phi Epslion about SigEp or greek life in general">
  ...
  <body>
    ...
    <main class="main" id="main">
      ...
      <div class="container">
        <h2>Get in touch</h2>
        <p>
          Feel free to contact a remember if you have any questions about Sigma
          Phi Epsilon or anything Greek Life or campus life related.
        </p>
        <hr />
        <h2>SigEp PABB Executive Board</h2>
        <div class="row">
